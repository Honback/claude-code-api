...
from claude_code_api.api.auth import router as auth_router
...
from claude_code_api.api.rate_limits import router as rate_limits_router
from claude_code_api.api.sessions import router as sessions_router
from claude_code_api.api.summarize import router as summarize_router
...
app.include_router(rate_limits_router, tags=["rate-limits"])
